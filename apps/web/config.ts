...
const config = {
  ...
  appDescription:
    "Transform political anxiety into political efficacy. A free, non-partisan political tracker app that helps Gen Z navigate politics with clarity and confidence.",
  // REQUIRED (no https://, not trailing slash at the end, just the naked domain)
  domainName: "efficacy-app.com",
  crisp: {
  ...
  resend: {
    ...
    fromNoReply: `Efficacy <noreply@efficacy-app.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `Efficacy Team <team@efficacy-app.com>`,
    // Email shown to customer if they need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "support@efficacy-app.com",
  },
  colors: {
